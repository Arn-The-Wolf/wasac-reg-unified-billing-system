/**
 * REST controller exposing MeterController endpoints for the WASAC/REG billing system.
 *
...
public class MeterController {
    ...
    public ResponseEntity<ApiResponse<MeterResponse>> getById(
    ...
    @PreAuthorize("hasAnyRole('ADMIN', 'OPERATOR', 'FINANCE', 'CUSTOMER')")
    public ResponseEntity<ApiResponse<List<MeterResponse>>> getByCustomer(
    ...
    @PreAuthorize("hasAnyRole('ADMIN', 'OPERATOR')")
    public ResponseEntity<ApiResponse<MeterResponse>> activate(
            @PathVariable @Positive(message = AppConstants.ID_POSITIVE_MESSAGE) Long id) {
    ...
    @PreAuthorize("hasAnyRole('ADMIN', 'OPERATOR')")
    public ResponseEntity<ApiResponse<MeterResponse>> deactivate(
            @PathVariable @Positive(message = AppConstants.ID_POSITIVE_MESSAGE) Long id) {
